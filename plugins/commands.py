...
main_buttons = [[
        InlineKeyboardButton('❣️ ᴅᴇᴠᴇʟᴏᴘᴇʀ ❣️', url='http://telegram.me/Heisenberg1609')
        ],[
        InlineKeyboardButton('📜 sᴜᴘᴘᴏʀᴛ  ', url='http://telegram.me/Heisenberg1609'),
        InlineKeyboardButton('🤖 ᴜᴘᴅᴀᴛᴇ ᴄʜᴀɴɴᴇʟ  ', url='https://t.me/INDORECINEMAS5')
        ],[
